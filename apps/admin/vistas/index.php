...
<head>	
	...
	<?php 
		...
		$rutaMod='/web/apps/<?php echo $_PETICION->modulo; ?>/css/mods/black-tie/black-tie.css';
	?>
	...
	<script src="/web/apps/<?php echo $_PETICION->modulo; ?>/libs/Wijmo.2.3.2/Wijmo-Complete/js/jquery.wijmo-complete.all.2.3.2.js" type="text/javascript"></script>
	<script src="/web/apps/<?php echo $_PETICION->modulo; ?>/libs/Wijmo.2.3.2/Wijmo-Open/js/jquery.wijmo-open.all.2.3.2.js" type="text/javascript"></script>		
	<!-- Gritter -->
	<link href="/web/apps/<?php echo $_PETICION->modulo; ?>/libs/Gritter-master/css/jquery.gritter.css" rel="stylesheet" type="text/css" />
	<script src="/web/apps/<?php echo $_PETICION->modulo; ?>/libs/Gritter-master/js/jquery.gritter.min.js" type="text/javascript"></script>
	<script src="/web/apps/<?php echo $_PETICION->modulo; ?>/libs/shortcut.js"></script>  	
	...
	<script src="/web/apps/<?php echo $_PETICION->modulo; ?>/js/funciones.js" type="text/javascript"></script>
	<script src="/web/apps/<?php echo $_PETICION->modulo; ?>/js/TabManager.js" type="text/javascript"></script>
