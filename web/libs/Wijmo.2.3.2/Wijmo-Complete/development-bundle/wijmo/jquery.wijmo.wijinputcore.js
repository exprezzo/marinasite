    ...
    var wijinputcore = (function (_super) {
        ...
        wijinputcore.prototype._popupComboList = function () {
            ...
            if(this._comboDiv === undefined) {
                this._comboDiv = $("<div></div>").appendTo(document.body).width(this.outerDiv.width()).css('position', 'absolute');
            ...
            this._comboDiv.height(this.options.comboHeight || 180).wijlist("refreshSuperPanel").wijpopup({
                autoHide: true
            });
