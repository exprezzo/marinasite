...
(function (wijmo) {
    ...
    var wijinputdate = (function (_super) {
        ...
        wijinputdate.prototype._initialize = function () {
            var _this = this;
            _super.prototype._initialize.call(this);
            if(this.triggerBtn) {
                this.triggerBtn.bind('mouseup', function (e) {
                    var calendar = _this.element.data('calendar');
                    _this._showingCalendar = calendar && calendar.wijcalendar('isPopupShowing');
                });
            }
        };
